// this is the config class where all other classes will be loaded and the logic is written
...
import {fromToFunctions} from "../config/fromToFunctions";
import {loopFunctions} from "../config/loopFunctions";
...
class Game {
    constructor() {
        ...
        this.bgPlane = new BABYLON.Layer("back", null, this.scene, true);
    ...
    setup() {
        ...
        this.playBtn.addEventListener('click', ()=>{
            ...
            if (counter === 0) {
                ...
                // Play intro Video to the config char
